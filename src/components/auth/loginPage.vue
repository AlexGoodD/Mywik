<template>
  <div class="tw-bg-transparent tw-rounded-xl tw-w-full tw-h-full tw-shadow-md tw-flex tw-flex-col tw-gap-3">
    ...
    />
    <button class="tw-border tw-bg-[#1f1f1f] tw-border-[#6D6D6D] tw-rounded-lg tw-flex tw-justify-center tw-gap-x-4 tw-items-center tw-transition-colors tw-duration-500 hover:tw-bg-[#444444] hover:tw-border hover:tw-border-[#878787]" @click="handleLoginClick">
